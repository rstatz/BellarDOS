...
C_OBJ=kmain.o irq.o vga_cd.o ps2_cd.o serial_cd.o strings.o math.o print.o splash.o pic_cd.o gdt.o ist.o idt.o mmap.o mmu.o kmalloc.o multitask.o time.o test.o debug.o snakes.o
...
$(kernel): $(ASM_OBJ) $(linker_script) $(C_FILES)
	...
	$(CC) -o time.o $(C_FLAGS) $(path)/time.c $(LIBS)
	...
	$(CC) -o snakes.o $(C_FLAGS) $(path)/snakes.c $(LIBS)
